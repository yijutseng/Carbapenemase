...
CombineData_comp_conv_3 <- read_csv("CombineData_comp_conv_3.csv")
```
...
CombineData_conven<-left_join(CombineData,
                              df.merge %>% select(ID,mCIM.x,mCIM.y) %>%
                                rename(FirstAll_mCIM=mCIM.x,Conventional_mCIM=mCIM.y),
                              by = join_by(ID))

write_csv(CombineData,"CombineData_comp_1.csv")
write_csv(CombineData_conven,"CombineData_comp_conv_1.csv")
...
dimnames(mCIM.comp)[[1]]<-c("FirstAll-mCIM(-)","FirstAll-mCIM(+)")
mCIM.comp
dimnames(mCIM.comp)[[2]]<-c("Conventional-mCIM(-)","Conventional-mCIM(+)")
...
plot_confusion_matrix(eval,
  ...
  labs(x="FirstAll",y="Conventional")
...
##B: NDM/IMP/VIM only
##D: OXA only
##Other: any combination of carbapenemase


CombineData_comp_conv_3$Conventional_MPCR_Group<-"Others"
CombineData_comp_conv_3$Conventional_MPCR_Group<-
  ifelse(CombineData_comp_conv_3$Conventional_MPCR=="KPC",
         "Class A",CombineData_comp_conv_3$Conventional_MPCR_Group)
CombineData_comp_conv_3$Conventional_MPCR_Group<-
  ifelse(CombineData_comp_conv_3$Conventional_MPCR=="OXA",
         "Class D",CombineData_comp_conv_3$Conventional_MPCR_Group)
CombineData_comp_conv_3$Conventional_MPCR_Group<-
  ifelse(CombineData_comp_conv_3$Conventional_MPCR=="NDM"|
           CombineData_comp_conv_3$Conventional_MPCR=="IMP"|
           CombineData_comp_conv_3$Conventional_MPCR=="VIM"|
           CombineData_comp_conv_3$Conventional_MPCR=="NDM+VIM",
         "Class B",CombineData_comp_conv_3$Conventional_MPCR_Group)
CombineData_comp_conv_3$Conventional_MPCR_Group<-
  ifelse(CombineData_comp_conv_3$Conventional_MPCR=="Negative",
         "Negative",CombineData_comp_conv_3$Conventional_MPCR_Group)

CombineData_comp_conv_3$FirstAll_MPCR_Group<-"Others"
CombineData_comp_conv_3$FirstAll_MPCR_Group<-
  ifelse(CombineData_comp_conv_3$FirstAll_MPCR=="KPC",
         "Class A",CombineData_comp_conv_3$FirstAll_MPCR_Group)
CombineData_comp_conv_3$FirstAll_MPCR_Group<-
  ifelse(CombineData_comp_conv_3$FirstAll_MPCR=="OXA",
         "Class D",CombineData_comp_conv_3$FirstAll_MPCR_Group)
CombineData_comp_conv_3$FirstAll_MPCR_Group<-
  ifelse(CombineData_comp_conv_3$FirstAll_MPCR=="NDM"|
           CombineData_comp_conv_3$FirstAll_MPCR=="IMP"|
           CombineData_comp_conv_3$FirstAll_MPCR=="VIM"|
           CombineData_comp_conv_3$FirstAll_MPCR=="NDM+VIM",
         "Class B",CombineData_comp_conv_3$FirstAll_MPCR_Group)
CombineData_comp_conv_3$FirstAll_MPCR_Group<-
  ifelse(CombineData_comp_conv_3$FirstAll_MPCR=="Negative",
         "Negative",CombineData_comp_conv_3$FirstAll_MPCR_Group)

##Remove
##FirstAll_MPCR vs. Conventional_MPCR
##KPC+OXA KPC+OXA+NDM
##KPC+OXA+NDM KPC+OXA
CombineData_comp_conv_3$FirstAll_MPCR_Group<-
  ifelse(CombineData_comp_conv_3$FirstAll_MPCR=="KPC+OXA" & 
           CombineData_comp_conv_3$Conventional_MPCR=="KPC+OXA+NDM",
         NA,CombineData_comp_conv_3$FirstAll_MPCR_Group)
CombineData_comp_conv_3$FirstAll_MPCR_Group<-
  ifelse(CombineData_comp_conv_3$FirstAll_MPCR=="KPC+OXA+NDM" & 
           CombineData_comp_conv_3$Conventional_MPCR=="KPC+OXA",
         NA,CombineData_comp_conv_3$FirstAll_MPCR_Group)
CombineData_comp_conv_3$Conventional_MPCR_Group<-
  ifelse(CombineData_comp_conv_3$FirstAll_MPCR=="KPC+OXA" & 
           CombineData_comp_conv_3$Conventional_MPCR=="KPC+OXA+NDM",
         NA,CombineData_comp_conv_3$Conventional_MPCR_Group)
CombineData_comp_conv_3$Conventional_MPCR_Group<-
  ifelse(CombineData_comp_conv_3$FirstAll_MPCR=="KPC+OXA+NDM" & 
           CombineData_comp_conv_3$Conventional_MPCR=="KPC+OXA",
         NA,CombineData_comp_conv_3$Conventional_MPCR_Group)

CombineData_comp_conv_3<-
  CombineData_comp_conv_3[!is.na(CombineData_comp_conv_3$FirstAll_MPCR_Group),]

CombineData_comp_conv_3$Conventional_MPCR_Group<-
  factor(CombineData_comp_conv_3$Conventional_MPCR_Group,
         levels=c("Class A","Class B","Class D","Others","Negative"))
CombineData_comp_conv_3$FirstAll_MPCR_Group<-
  factor(CombineData_comp_conv_3$FirstAll_MPCR_Group,
         levels=c("Negative","Others","Class D","Class B","Class A"))


CombineData_comp_conv_3 %>% group_by(Conventional_MPCR_Group,FirstAll_MPCR_Group) %>%
  summarise(Count=n()) %>%
  ggplot(aes(x=Conventional_MPCR_Group,y=FirstAll_MPCR_Group,fill=Count,label=Count))+
  geom_tile()+geom_text()+
  theme_classic()+#mdthemes::md_theme_classic() +
  labs(x="Conventional - MPCR",y="FirstAll - MPCR")+
  scale_fill_gradient(low="#F7FBFF",high=highcolor)

ggsave("Fig2-Con_vs_FirstAll_PCR.pdf",device = "pdf",width = 6,height = 4)
```
...
ggsave("Fig3.pdf",device = "pdf",width = 12,height = 8)
```
...
ggsave("Fig4A.pdf",device = "pdf",width = 8,height = 6)
```
...
CombineData %>% group_by(CARBA5Group,CPO) %>%
  ...
  scale_x_discrete(guide = guide_axis(n.dodge=2))+
  scale_fill_gradient(low="#F7FBFF",high=highcolor)+
  theme_classic()+labs(x="CPO",y="CARBA5",fill="Count",title="Whole isolates")
ggsave("Fig5A.pdf",device = "pdf",width = 8,height = 6)
```
...
ggsave("Fig6A.pdf",device = "pdf",width = 6,height = 4)
```
...
MICCPOCARBA5 %>% filter(Ab=="Ceftazidime-Avibactam") %>%
  ...
  theme_classic()+
  labs(x="MIC",y="CARBA5",title="Ceftazidime-Avibactam")
ggsave("Fig6B.pdf",device = "pdf",width = 6,height = 4)
```
...
CombineData %>%
  ...
  ungroup() %>%
      ...
      scale_fill_gradient(low="#F7FBFF",high=highcolor)
ggsave("Fig4B.pdf",device = "pdf",width = 6,height = 4)
```
...
#CombineData %>%
#  filter(is.na(MPCR))
CombineData$CARBA5Group<-factor(CombineData$CARBA5Group,
                                levels=c("Negative","Others","IMP/NDM/VIM","KPC/OXA"))
CombineData %>%
  ...
  geom_tile()+geom_text()+
  theme_classic()+
  labs(x="CPO",y="CARBA5",title="MPCR-positive isolates")+
  scale_fill_gradient(low="#F7FBFF",high=highcolor)
ggsave("Fig5B.pdf",device = "pdf",width = 6,height = 4)
```
