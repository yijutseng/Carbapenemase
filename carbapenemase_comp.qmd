...
ggsave("Fig6A.pdf",device = "pdf",width = 8,height = 6)
```
...
MICCPOCARBA5 %>% filter(Ab=="Ceftazidime-Avibactam") %>%
  ...
  theme_classic()+
  labs(x="MIC",y="CARBA5",title="Ceftazidime-Avibactam")
ggsave("Fig6B.pdf",device = "pdf",width = 8,height = 6)
```
...
CombineData %>%
  ...
  ungroup() %>%
      ...
      scale_fill_gradient(low="#F7FBFF",high=highcolor)
ggsave("Fig4B.pdf",device = "pdf",width = 8,height = 6)
```
...
CombineData %>%
  ...
  scale_fill_gradient(low="#F7FBFF",high=highcolor)
ggsave("Fig5B.pdf",device = "pdf",width = 8,height = 6)
```
