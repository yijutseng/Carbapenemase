...
HugeGENE %>% filter(SPECIES=="KP") %>% 
  ...
  theme_classic()+
  labs(x="MPCR",y="CARBA",title=expression(italic('Klebsiella pneumoniae')))+
...
#| echo: false
MICCPOMPCR<-
  inner_join(MICCPO,CPOMPCR, by = c("ID", "Name", "Marker"))
